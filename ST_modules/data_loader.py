...
class FilteredDatasetFolder(data.Dataset):
    ...
    def __init__(self, train, train_labels, extensions, transform=None, target_transform=None, transform_basic=None, filter_classes=None):
        #classes, class_to_idx = self.find_classes(root)
        #samples = self.make_dataset(root, split, filter_classes)
        samples = []
        for i in range(len(train_labels)):
            samples.append((train[i],train_labels[i]))
    ...
    def __getitem__(self, index):
        ...
        if self.target_transform is not None: #pode dar problema aqui
...
#train_set = RODFolder(train, train_labels, target_transform=None, transform=transform_train)
    def __init__(self, train, train_labels, transform=None, target_transform=None, transform_basic=None, classes=None):
        super(RODFolder, self).__init__(train, train_labels, IMG_EXTENSIONS,transform=transform,
